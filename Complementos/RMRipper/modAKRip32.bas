...
Public Function GetAKRipError() As String
  ...
  Case ALERR_NOWNASPI: GetAKRipError = "No se puede cargar WNASPI32.DLL (95/98/ME/NT/2000)."
  Case ALERR_NOGETASPI32SUPP: GetAKRipError = "No se puede leer la funcion ASPI GetASPI32SupportInfo. Ocurre unicamente cuando el manejador ASPI (WNASPI32.DLL) se encuentra, pero no puede ser leído correctamente por el sistema. Posiblemente deba reinstalarlo."
  Case ALERR_NOSENDASPICMD: GetAKRipError = "No se puede leer la funcion ASPI SendASPI32Command. ocurre unicamente cuando el manejador ASPI (WNASPI32.DLL) se encuentra, pero no puede ser leído por el sistema. Posiblemente deba reinstalarlo."
  Case ALERR_ASPI: GetAKRipError = "ASPI manager ha retornado un error. Use GetAspiLibAspiError para extraer el error ASPI."
  Case ALERR_NOCDSELECTED: GetAKRipError = "No se usa en la implementacion actual."
