VERSION 5.00
Begin VB.UserControl rmCommand 
   AutoRedraw      =   -1  'True
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ...
   PropertyPages   =   "rmCommand.ctx":0000
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   ToolboxBitmap   =   "rmCommand.ctx":004D
...
Private tCustomStyle As rmCommandStyle
...
Private Sub UserControl_InitProperties()
    ...
    With Me
        ...
        .CustomStyle = [Defaut Style - rmCommand]
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    With PropBag
        ...
        Call .WriteProperty("CustomStyle", Me.CustomStyle, [Defaut Style - rmCommand])
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        Me.CustomStyle = .ReadProperty("CustomStyle", [Defaut Style - rmCommand])
...
Public Property Let ForeColor(ForeColor As OLE_COLOR): lForeColor = ForeColor: UserControl.ForeColor = ForeColor: bNotOk = False: UserControl_Paint: tCustomStyle = [No Style - rmCommand]: End Property
Public Property Get BackColor1() As OLE_COLOR: BackColor1 = bCol1: End Property
Public Property Let BackColor1(BackColor1 As OLE_COLOR): tCustomStyle = [No Style - rmCommand]: bCol1 = BackColor1: bNotOk = False: UserControl_Paint: End Property
Public Property Get BackColor2() As OLE_COLOR: BackColor2 = bCol2: End Property
Public Property Let BackColor2(BackColor2 As OLE_COLOR): tCustomStyle = [No Style - rmCommand]: bCol2 = BackColor2: bNotOk = False: UserControl_Paint: End Property
Public Property Get BackColorPushed1() As OLE_COLOR: BackColorPushed1 = tCol1: End Property
Public Property Let BackColorPushed1(BackColorPushed1 As OLE_COLOR): tCustomStyle = [No Style - rmCommand]: tCol1 = BackColorPushed1: bNotOk = False: UserControl_Paint: End Property
Public Property Get BackColorPushed2() As OLE_COLOR: BackColorPushed2 = tCol2: End Property
Public Property Let BackColorPushed2(BackColorPushed2 As OLE_COLOR): tCustomStyle = [No Style - rmCommand]: tCol2 = BackColorPushed2: bNotOk = False: UserControl_Paint: End Property
...
Public Property Let BackGradient(BackGradient As GradientConstants): tCustomStyle = [No Style - rmCommand]: lGradient = BackGradient: bNotOk = False: UserControl_Paint: End Property
...
Public Property Let BorderColor(BorderColor As OLE_COLOR): tCustomStyle = [No Style - rmCommand]: lBorderColor = BorderColor: bNotOk = False: UserControl_Paint: End Property
Public Property Get BreakCorner() As Boolean: BreakCorner = bBreakCorner: End Property
Public Property Let BreakCorner(BreakCorner As Boolean): tCustomStyle = [No Style - rmCommand]: bBreakCorner = BreakCorner: bNotOk = False: UserControl_Paint: End Property
...
Public Property Let DrawFocus(DrawFocus As Boolean): tCustomStyle = [No Style - rmCommand]: bDrawFocus = DrawFocus: bNotOk = False: UserControl_Paint: End Property
Public Property Get DrawMouseInRect() As Boolean: DrawMouseInRect = bDrawMouseInRect: End Property
Public Property Let DrawMouseInRect(DrawMouseInRect As Boolean): tCustomStyle = [No Style - rmCommand]: bDrawMouseInRect = DrawMouseInRect: bNotOk = False: UserControl_Paint: End Property
Public Property Get DisabledBackColor() As OLE_COLOR: DisabledBackColor = lNotEnabledColor: End Property
Public Property Let DisabledBackColor(DisabledBackColor As OLE_COLOR): tCustomStyle = [No Style - rmCommand]: lNotEnabledColor = DisabledBackColor: bNotOk = False: UserControl_Paint: End Property
...
Public Property Get CustomStyle() As rmCommandStyle: CustomStyle = tCustomStyle: End Property
Public Property Let CustomStyle(CustomStyle As rmCommandStyle)
    tCustomStyle = CustomStyle
    
    Select Case CustomStyle
        Case [Defaut Style - rmCommand]
            bCol1 = &HFBFBFB
            bCol2 = &HDCDCDC
            tCol1 = &HC8C8C8
            tCol2 = &HEBEBEB
