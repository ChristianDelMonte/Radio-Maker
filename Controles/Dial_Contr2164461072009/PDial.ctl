...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    m_LColor = PropBag.ReadProperty("LColor", RGB(0, 185, 255))
    m_LPoint = PropBag.ReadProperty("LPoint", True)
    m_LRadius = PropBag.ReadProperty("LRadius", 22)
    
    m_DrehColor = PropBag.ReadProperty("DrehColor", RGB(0, 185, 255))
    m_DrehColOff = PropBag.ReadProperty("DrehColOff", vbBlue)
    m_DrehRadius = PropBag.ReadProperty("DrehRadius", 40)
    m_DrehShow = PropBag.ReadProperty("DrehShow", 0)
    
    m_KnobColor = PropBag.ReadProperty("KnobColor", vbWhite)
    Set m_KnobImage = PropBag.ReadProperty("KnobImage", Nothing)
    m_KnobRadius = PropBag.ReadProperty("KnobRadius", 35)
    
    m_TextColor = PropBag.ReadProperty("TextColor", RGB(0, 185, 255))
    m_TicksColor = PropBag.ReadProperty("TicksColor", m_TextColor)
    
    m_TextShow = PropBag.ReadProperty("TextShow", 2)
    m_Text = PropBag.ReadProperty("Text", "L R")
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("LColor", m_LColor, RGB(0, 185, 255))
    Call PropBag.WriteProperty("LPoint", m_LPoint, True)
    Call PropBag.WriteProperty("LRadius", m_LRadius, 22)
    
    Call PropBag.WriteProperty("KnobColor", m_KnobColor, vbWhite)
    Call PropBag.WriteProperty("KnobImage", m_KnobImage, Nothing)
    Call PropBag.WriteProperty("KnobRadius", m_KnobRadius, 35)
    
    Call PropBag.WriteProperty("DrehColor", m_DrehColor, RGB(0, 185, 255))
    Call PropBag.WriteProperty("DrehColOff", m_DrehColOff, vbBlue)
    Call PropBag.WriteProperty("DrehShow", m_DrehShow, 0)
    Call PropBag.WriteProperty("DrehRadius", m_DrehRadius, 40)
    
    Call PropBag.WriteProperty("TextColor", m_TextColor, RGB(0, 185, 255))
    Call PropBag.WriteProperty("TicksColor", m_TicksColor, m_TextColor)
    Call PropBag.WriteProperty("TextShow", m_TextShow, 2)
    Call PropBag.WriteProperty("Text", m_Text, "L R")
...
Private Sub UserControl_InitProperties()
 ...
 m_Max = 100
 m_Value = 50
 m_LColor = RGB(0, 185, 255)
 m_LRadius = 22
 m_LPoint = True
 m_BackColor = vbButtonFace
 m_DrehColor = RGB(0, 185, 255)
 m_DrehColOff = vbBlue
 m_DrehShow = 0
 m_DrehRadius = 40
 ...
 m_TextShow = 2
 m_Text = "L R"
 m_TextColor = RGB(0, 185, 255)
 m_TicksColor = RGB(0, 185, 255)
 Call UserControl_Resize
