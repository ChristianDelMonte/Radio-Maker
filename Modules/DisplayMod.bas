...
Select Case EstNum
    Case 1
        For NumCon = 0 To 21
            Est01.E11(NumCon).BackColor = &H534F4C     '&H8000000F     'GRIS (cara del boton)
        Next NumCon
    Case 2
        For NumCon = 0 To 21
            Est02.E21(NumCon).BackColor = &H8000000F     'GRIS (cara del boton)
        Next NumCon
...
Select Case EstNum
    Case 1
        Est01.E11(index).BackColor = &H534F4C      '&H8000000F     'GRIS (cara del boton)
    Case 2
        Est02.E21(index).BackColor = &H8000000F     'GRIS (cara del boton)
End Select
...
Select Case EstNum
    Case 1
        Est01.E11(index).BackColor = &HC0C000      '&H8000000E     'BLANCO (resalte de texto)
    Case 2
        Est02.E21(index).BackColor = &H8000000E     'BLANCO (resalte de texto)
End Select
